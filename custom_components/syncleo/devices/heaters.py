...
from ..const import (
    ...
    PRESET_ANTI_FROST,
    PRESET_AURUS_PF_SCREENSAVER_MODE_1,
    PRESET_AURUS_PF_SCREENSAVER_MODE_3,
    PRESET_AURUS_PF_SCREENSAVER_MODE_5,
    PRESET_AURUS_PF_SCREENSAVER_MODE_OFF,
    PRESET_MANUAL,
    PRESET_VACATION,
    VENDOR_RUSCLIMATE,
)
...
PROFILES = [
    ...
    ClimateProfile(
        ...
        selects={
            FEATURE_AURUS_PF_SCREENSAVER_MODE: SelectConfig(
                options_map={
                    PRESET_AURUS_PF_SCREENSAVER_MODE_OFF: 0,
                    PRESET_AURUS_PF_SCREENSAVER_MODE_1: 1,
                    PRESET_AURUS_PF_SCREENSAVER_MODE_3: 2,
                    PRESET_AURUS_PF_SCREENSAVER_MODE_5: 3,
                },
            ),
        },
        switches=[
