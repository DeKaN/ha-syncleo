...
FEATURE_TO_COMMAND_MAP = {
    ...
    FEATURE_EXPENDABLES_PREFILTER: CmdExpendables,
    ...
    FEATURE_BREEZER_DAMPER: CmdDamper,
    FEATURE_BREEZER_MELODY: CmdAmount,
    FEATURE_BREEZER_TEMPERATURE: CmdTargetTemperature,
